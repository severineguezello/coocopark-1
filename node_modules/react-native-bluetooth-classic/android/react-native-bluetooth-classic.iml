...
<module external.linked.project.id=":react-native-bluetooth-classic" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../BluetoothClassicExample/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-bluetooth-classic" />
      </configuration>
    </facet>
